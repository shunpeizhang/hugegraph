...
public class GraphIndexTransaction extends AbstractTransaction {
    ...
    public static class RemoveLeftIndexJob extends EphemeralJob<Object> {
        ...
        protected int removeIndexLeft(ConditionQuery query,
                                      HugeElement element) {
        ...
        private int processRangeIndexLeft(ConditionQuery query,
                                          HugeElement element) {
        ...
        private int processSecondaryOrSearchIndexLeft(ConditionQuery query,
                                                      HugeElement element) {
